...
String hise::FrontendHandler::getProjectName() { return "Torch"; };
String hise::FrontendHandler::getCompanyName() { return "In Reach Entertainment"; };
String hise::FrontendHandler::getCompanyWebsiteName() { return "http://inreachentertainment.com"; };
String hise::FrontendHandler::getVersionString() { return "1.1.0"; };
